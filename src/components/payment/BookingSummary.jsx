  ...
  return (
     <div className="booking-summary">
      ...
      <div className="summary-details">
        ...
        <p><strong>Check-in:</strong> {bookingDetails?.checkIn ? new Date(bookingDetails.checkIn).toLocaleDateString() : 'N/A'}</p>
        <p><strong>Check-out:</strong> {bookingDetails?.checkOut ? new Date(bookingDetails.checkOut).toLocaleDateString() : 'N/A'}</p>
